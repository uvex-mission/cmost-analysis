...
def get_temp(cmost=1):
    ...
    if cmost == 1:
        temp_url = 'https://sites.astro.caltech.edu/~detlab/uvex/'+year+'/'+datestring+'/temps.csv'
    elif cmost == 2:
    ...
    temp = last_line[2]
    # If implementing past dates, make sure to look at column [1] for old CMOST temperature readings between 2021 and 2024
